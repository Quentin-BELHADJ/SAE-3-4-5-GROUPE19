...
def fct_fixtures_load():
   ...
   PRIMARY KEY(id_fournisseur)
    ...
    sql = '''CREATE TABLE IF NOT EXISTS lunette(
...
(4, 'Safilo');'''
    ...
    sql = '''INSERT INTO lunette (id_lunette, libelle_lunette, prix_lunette, couleur_id, categorie_id, marque_id, fournisseur_id) VALUES
...
(15, 'Lunettes sans branches', 199.99, 2, 4, 1, 4);'''
    ...
    sql = '''INSERT INTO etat(id_etat, libelle_etat) VALUES (1,'en attente'),
                                               (2,'expédié'),
                                               (3,'validé'),
                                               (4,'confirmé');'''
    mycursor.execute(sql)
